...
public class svc extends ShadowVillageCommand {
    ...
    private void help(Player player) {
        if (player.hasPermission("svc.help")) {
            ...
            text2.append("1.武器抽奖：\n");
            text2.append("/svb g 1 钻石数\n\n");
            text2.append("2.头盔抽奖：\n");
            text2.append("/svb g 2 钻石数\n\n");
            text2.append("3.胸甲抽奖：\n");
            text2.append("/svb g 3 钻石数\n\n");
            text2.append("4.护腿抽奖：\n");
            text2.append("/svb g 4 钻石数\n\n");
            bookMeta.addPage(text2.toString());

            StringBuilder text3 = new StringBuilder();
            text3.append("影之乡黑市系统\n\n");
            text3.append("5.靴子抽奖：\n");
            text3.append("/svb g 5 钻石数\n\n");
            text3.append("6.影之石数量查询：\n");
            text3.append("/svb l shadowstone");
