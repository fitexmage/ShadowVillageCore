...
class GambleItemInfo {
    ...
    static GambleItemInfo[] getGambleItemInfos(int gambleType) {
        switch (gambleType) {
            ...
            case 2:
                return new GambleItemInfo[]{
                        new GambleItemInfo(20001, "影之弓", Material.BOW, 300, 0, 4),
                        new GambleItemInfo(29999, "§5腐竹的精准", Material.BOW, 1000, 150, 7)
                };
            case 3:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(39999, "§5腐竹的掌控", Material.DIAMOND_HELMET, 1000, 150, 7)
                };
            case 4:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(49999, "§5腐竹的坚定", Material.DIAMOND_CHESTPLATE, 1000, 150, 7)
                };
            case 5:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(59999, "§5腐竹的灵动", Material.DIAMOND_LEGGINGS, 1000, 150, 7)
                };
            case 6:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(69999, "§5腐竹的疾风", Material.DIAMOND_BOOTS, 1000, 150, 7)
                };
            default:
                return new GambleItemInfo[]{};
        }
