        ...
        switch (gambleType) {
            case 1:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(19999, "§5腐竹的锐利", Material.DIAMOND_SWORD, 550, 200, 7)
                };
            case 2:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(29999, "§5腐竹的掌控", Material.DIAMOND_HELMET, 1200, 50, 7)
                };
            case 3:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(39999, "§5腐竹的坚定", Material.DIAMOND_CHESTPLATE, 1200, 50, 7)
                };
            case 4:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(49999, "§5腐竹的灵动", Material.DIAMOND_LEGGINGS, 1200, 50, 7)
                };
            case 5:
                return new GambleItemInfo[]{
                        ...
                        new GambleItemInfo(59999, "§5腐竹的疾风", Material.DIAMOND_BOOTS, 1200, 50, 7)
                };
            default:
                return new GambleItemInfo[]{};
        }
